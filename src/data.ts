...
export const VIDEOS: Video[] = [
  { id: '1', title: 'Incredible catch by Zimbabwe', thumbnail: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?auto=format&fit=crop&w=400&q=80', url: 'https://vimeo.com/1169985946', category: 'Best Catches', duration: '0:30', views: '1.2M', description: 'An unbelievable catch by the Zimbabwe fielder to dismiss the batsman.' },
